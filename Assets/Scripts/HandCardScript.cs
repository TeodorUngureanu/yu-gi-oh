...
public class HandCardScript : InteractibleAbstractCard
{
    ...
    public void SetData(int vCardIndex, Enums.CardType vCardType, string cardFileName)
    {
        cardIndex = vCardIndex;
        cardType = vCardType;
        ...
        Texture2D texture = Resources.Load<Texture2D>("Images/Card Images/" + cardFileName);
